...
import fr.osalys.mod.block.AntimatterClusterBlock;
import fr.osalys.mod.OsalysmodMod;

public class LargeAntimatterCludMiseAJourDuTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				OsalysmodMod.LOGGER.warn("Failed to load dependency world for procedure LargeAntimatterCludMiseAJourDuTick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				OsalysmodMod.LOGGER.warn("Failed to load dependency x for procedure LargeAntimatterCludMiseAJourDuTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				OsalysmodMod.LOGGER.warn("Failed to load dependency y for procedure LargeAntimatterCludMiseAJourDuTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				OsalysmodMod.LOGGER.warn("Failed to load dependency z for procedure LargeAntimatterCludMiseAJourDuTick!");
			return;
		}
		...
		if ((new Object() {
			...
			world.setBlockState(new BlockPos(x, y, z), AntimatterClusterBlock.block.getDefaultState(), 3);
			try {
