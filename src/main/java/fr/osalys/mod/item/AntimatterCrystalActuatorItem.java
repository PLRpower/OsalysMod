...
public class AntimatterCrystalActuatorItem extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:antimatter_crystal_actuator")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			AntimatterCrystalActuatorLorsqueVousCliquezAvecLeBoutonDroitDeLaSourisSurUnBlocProcedure.executeProcedure(Stream
