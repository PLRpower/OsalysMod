...
public class RenforcedFortuneHoeItem extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:renforced_fortune_hoe")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("renforced_fortune_hoe");
		}
