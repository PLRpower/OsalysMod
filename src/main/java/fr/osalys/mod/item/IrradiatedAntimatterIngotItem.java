...
import fr.osalys.mod.procedures.AntimatterIngotQuandLitemEstDansLinventaireParTickProcedure;
...
public class IrradiatedAntimatterIngotItem extends OsalysmodModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			AntimatterIngotQuandLitemEstDansLinventaireParTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
