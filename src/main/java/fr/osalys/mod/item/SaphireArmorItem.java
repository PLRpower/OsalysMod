...
public class SaphireArmorItem extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:saphire_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("osalysmod:saphire_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("osalysmod:saphire_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("osalysmod:saphire_armor_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(OsalysTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "osalysmod:textures/models/armor/saphire__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
