...
public class AntimatterArmorItem extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:antimatter_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("osalysmod:antimatter_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("osalysmod:antimatter_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("osalysmod:antimatter_armor_boots")
