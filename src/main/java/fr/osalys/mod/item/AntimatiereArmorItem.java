...
public class AntimatiereArmorItem extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:antimatiere_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("osalysmod:antimatiere_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("osalysmod:antimatiere_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("osalysmod:antimatiere_armor_boots")
	public static final Item boots = null;

	public AntimatiereArmorItem(OsalysmodModElements instance) {
		super(instance, 9);
	}
