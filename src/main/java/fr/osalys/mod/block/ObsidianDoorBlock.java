...
public class ObsidianDoorBlock extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:obsidian_door")
	...
	public static class CustomBlock extends DoorBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ObsidianDoorBlock.block));
		}
	}
}
