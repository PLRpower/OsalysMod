...
import fr.osalys.mod.procedures.SaphirFurnaceProcedureProcedure;
import fr.osalys.mod.itemgroup.OsalysTabItemGroup;
import fr.osalys.mod.gui.GUIOsaliumFurnaceGui;
import fr.osalys.mod.OsalysmodModElements;

@OsalysmodModElements.ModElement.Tag
public class SaphirFurnaceBlock extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:saphir_furnace")
	public static final Block block = null;
	@ObjectHolder("osalysmod:saphir_furnace")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public SaphirFurnaceBlock(OsalysmodModElements instance) {
		super(instance, 278);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("saphir_furnace"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("saphir_furnace");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SaphirFurnaceProcedureProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("saphir_furnace");
		}
