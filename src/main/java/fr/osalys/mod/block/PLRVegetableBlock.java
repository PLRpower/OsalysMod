...
public class PLRVegetableBlock extends OsalysmodModElements.ModElement {

	@ObjectHolder("osalysmod:plr_vegetable")
	public static final Block block = null;

	public PLRVegetableBlock(OsalysmodModElements instance) {
		super(instance, 334);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plr_vegetable"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("osalysmod:plr_vegetable"), configuredFeature);
		}
