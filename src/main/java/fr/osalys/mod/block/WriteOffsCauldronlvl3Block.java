...
import fr.osalys.mod.procedures.WriteOffsCauldronMiseAJourDuTickProcedure;
import fr.osalys.mod.OsalysmodModElements;

@OsalysmodModElements.ModElement.Tag
public class WriteOffsCauldronlvl3Block extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:write_offs_cauldronlvl_3")
	public static final Block block = null;

	public WriteOffsCauldronlvl3Block(OsalysmodModElements instance) {
		super(instance, 220);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("write_offs_cauldronlvl_3");
		}
