...
import fr.osalys.mod.procedures.SmallAntimatterCludMiseAJourDuTickProcedure;
import fr.osalys.mod.itemgroup.OsalysTabItemGroup;
import fr.osalys.mod.item.AntimatterFragmentItem;
import fr.osalys.mod.OsalysmodModElements;

@OsalysmodModElements.ModElement.Tag
public class SmallAntimatterBudBlock extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:small_antimatter_bud")
	public static final Block block = null;

	public SmallAntimatterBudBlock(OsalysmodModElements instance) {
		super(instance, 207);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(40f, 0f).setLightLevel(s -> 15).harvestLevel(4)
			...
			setRegistryName("small_antimatter_bud");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SmallAntimatterCludMiseAJourDuTickProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			world.getPendingBlockTicks().scheduleTick(pos, this, 6000);
