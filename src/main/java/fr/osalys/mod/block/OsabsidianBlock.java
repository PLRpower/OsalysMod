...
public class OsabsidianBlock extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:osabsidian")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(70f, 1400f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("osabsidian");
		}
