...
import fr.osalys.mod.procedures.MediumAntimatterCludQuandLeBlocVoisinChangeProcedure;
import fr.osalys.mod.procedures.MediumAntimatterCludMiseAJourDuTickProcedure;
import fr.osalys.mod.itemgroup.OsalysTabItemGroup;
import fr.osalys.mod.OsalysmodModElements;

@OsalysmodModElements.ModElement.Tag
public class MediumAntimatterBudBlock extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:medium_antimatter_bud")
	public static final Block block = null;

	public MediumAntimatterBudBlock(OsalysmodModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(1.5f, 1.5f).setLightLevel(s -> 2)
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			MediumAntimatterCludQuandLeBlocVoisinChangeProcedure.executeProcedure(Stream
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			MediumAntimatterCludMiseAJourDuTickProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			world.getPendingBlockTicks().scheduleTick(pos, this, 100);
