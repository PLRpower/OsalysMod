...
public class TestcristauxBlock extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:testcristaux")
	public static final Block block = null;

	public TestcristauxBlock(OsalysmodModElements instance) {
		super(instance, 224);
	}
