...
import fr.osalys.mod.procedures.UnstableRockMiseAJourDuTickProcedure;
import fr.osalys.mod.itemgroup.OsalysTabItemGroup;
import fr.osalys.mod.OsalysmodModElements;

@OsalysmodModElements.ModElement.Tag
public class UnstableRockBlock extends OsalysmodModElements.ModElement {
	@ObjectHolder("osalysmod:unstable_rock")
	public static final Block block = null;

	public UnstableRockBlock(OsalysmodModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			UnstableRockMiseAJourDuTickProcedure.executeProcedure(Stream
