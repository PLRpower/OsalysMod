...
public class TestGuiGuiWindow extends ContainerScreen<TestGuiGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("osalysmod:textures/screens/test_gui.png");
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 435, this.guiTop + 27, 30, 20, new StringTextComponent("X"), e -> {
			if (true) {
				OsalysmodMod.PACKET_HANDLER.sendToServer(new TestGuiGui.ButtonPressedMessage(0, x, y, z));
