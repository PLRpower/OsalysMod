...
@OnlyIn(Dist.CLIENT)
public class CobaltBarrelGUIGuiWindow extends ContainerScreen<CobaltBarrelGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = CobaltBarrelGUIGui.guistate;

	public CobaltBarrelGUIGuiWindow(CobaltBarrelGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
