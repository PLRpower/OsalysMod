...
@OnlyIn(Dist.CLIENT)
public class PlatineBarrelGUIGuiWindow extends ContainerScreen<PlatineBarrelGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = PlatineBarrelGUIGui.guistate;

	public PlatineBarrelGUIGuiWindow(PlatineBarrelGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
