...
public class PlatineBarrelGUIGui extends OsalysmodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public PlatineBarrelGUIGui(OsalysmodModElements instance) {
		super(instance, 239);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("platine_barrel_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, PlatineBarrelGUIGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(103, this.addSlot(new SlotItemHandler(internal, 103, 15, 22) {
			}));
			...
			this.customSlots.put(102, this.addSlot(new SlotItemHandler(internal, 102, 33, 22) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
